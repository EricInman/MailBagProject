...
export class Worker {
  ...
  // allows the methods below to connect to the server
  ...
  // lists all the mailboxes in the server
  ...
  // gets all the messages in a selected mailbox
  ...
  public async getMessageBody(inCallOptions: ICallOptions): Promise<string> {
    ...
    await client.close();
    return parsed.text || "string was undefined (might be a problem)";
  }
